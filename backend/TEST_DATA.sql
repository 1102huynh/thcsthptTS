...
-- =====================================================
-- 0. CLEANUP - Delete existing data before inserting
-- =====================================================
...
-- Attendance: 15 records (Multiple entries per student)
-- Grades: 9 records (3 subjects per 3 students)
-- Fees: 7 records (Various fee types and statuses)
-- Book Transactions: 6 records (Borrow and return)
...
-- Plain text passwords: All users use "Test@123" (hashed above)
--
-- Test Logins:
-- Admin: username=admin, password=Test@123
-- Principal: username=principal, password=Test@123
-- Teacher: username=teacher1, password=Test@123
-- Librarian: username=librarian, password=Test@123
-- Accountant: username=accountant, password=Test@123
-- Student: username=student1, password=Test@123
--
-- =====================================================
-- NOTES FOR TESTING
-- =====================================================
-- 1. This data includes real test scenarios:
--    - Some fees paid, some pending
--    - Some books returned, some still borrowed
...
--    - Grades linked to Teachers and Students
--    - Fees linked to Students
--    - Book transactions linked to Users and Books
--
-- 3. Test all endpoints with different roles:
--    - Admin can access everything
--    - Teachers can manage attendance and grades
